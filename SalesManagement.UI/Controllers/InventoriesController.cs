...
namespace SalesManagement.UI.Controllers
{
    ...
    {
        private SalesManagementDemoEntities db = new SalesManagementDemoEntities();
        ...
        public ActionResult Create([Bind(Include = "Id,ProductId,InStock")] Inventory inventory)
        {
